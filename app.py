...
#     data = data.filter(l_freq = 4 , h_freq = 8)
#     data1 = data1.filter(l_freq = 4 , h_freq = 8)

#     #data.plot()

#     data = data.filter(l_freq = 8 , h_freq = 12)
#     data1 = data1.filter(l_freq = 8 , h_freq = 12)
#     #data.plot()

#     data = data.filter(l_freq = 0.5 , h_freq = 40)
#     data1 = data1.filter(l_freq = 0.5 , h_freq = 40)
#     #data.plot()
...
#     #exclude =  Channel order : 'FP1-F7','F7-T7','T7-P7','P7-O1','FP1-F3','F3-C3','C3-P3','P3-O1','FP2-F4','F4-C4','C4-P4','P4-O2','FP2-F8','F8-T8','T8-P8','P8-O2','FZ-CZ','CZ-PZ','P7-T7','T7-FT9','FT9-FT10','FT10-T8','T8-P8'
#     header = ','.join(data1.ch_names)
#     df11 = pd.DataFrame(data1[:][0])
#     df11= df11.transpose()
#     # df = df.iloc[1467*256:1477*256]
#     # df3

#     #for 1 and 8
#     df11.drop([1,2,3,4,6,7,8,9,11,12,13,14,16,17,18,20,21,22],axis=1,inplace=True)
#     df11.shape
...
#     with open('EpilepticSeizuredetectionDatasetCHBMIT1.csv', 'a') as file1:
#         writer1 = csv.writer(file)
#         while temp < end:    
#             row = add_row(df12, data, temp, temp + duration, index)
#             #res=res.append(pd.Series(row),ignore_index=True)
#             res1 = pd.concat([res1, pd.Series(row)], ignore_index=True)
...
#     file_path = r'C:/Users/HP/Downloads/dataset-20230409T104440Z-001/dataset/' + file.filename
#     file.save(file_path)
#     file_path1 = r'C:/Users/HP/Downloads/dataset-20230409T104440Z-001/dataset/' + file1.filename
#     file1.save(file_path1)

#     # Get the prediction
#     data = mne.io.read_raw_edf(file_path, preload=True)
#     data1 = mne.io.read_raw_edf(file_path, preload=True)
#     accuracy,accuracy1,accuracy2,accuracy3 = predict_edf(data)
